...
class SerialNew(models.Model):
    ...
    sales_price     = fields.Float(string='Sale Stone Price' ,help="Set Sale Stone price to day")
    purchase_price  = fields.Float(string='Purchase Stone Price' ,help="Set Purchase Stone price to day")
